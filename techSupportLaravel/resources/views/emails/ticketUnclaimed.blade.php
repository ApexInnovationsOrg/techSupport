...
a{
  ...
  <div style="margin:14pt 0 18.75pt 0; font-size:16px">{{ $employeeName }} has <b>unclaimed</b> the ticket <b>{{ $codeName }}</b> at {{ $time }}</div>
          ...
          <tr>
            ...
            <td style="padding:0 17.25pt 1.5pt 18pt;border-style:none;">
                <div align="center" style="text-align:center;margin:10px;">
                    <font face="Times New Roman,serif" size="3"><span style="font-size:12pt;"><a href={{ url('admin/techSupport/startTicket/?key='.$key) }} target="_blank" style="text-decoration:none; color:#ffffff"><font face="Segoe UI,sans-serif" size="4"><span style="font-size:13.5pt;"><font size="4" color="white"><span style="font-size:15pt;" style="color:#ffffff !important">Claim the ticket!&nbsp;&nbsp;></span></font>
                    </span>
                    </font>
                    </a>
                    </span>
