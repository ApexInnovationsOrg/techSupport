...
<p style="font-size:20px">{{ $name }},</p>
  ...
  <div style="margin:14pt 0 18.75pt 0; font-size:16px">
    <p>
    If you're receiving this email, you are eligible to upgrade your organization to Canadian Hemispheres 2.0! (It's <u>free</u>!)</p>
    <p>Press the upgrade button on the My Curriculum page, and that's it!</p>
    <a href="https://login.apexinnovations.com"><img src="<?php echo $message->embed('https://s3.amazonaws.com/uploads.hipchat.com/133998/972960/scBT3KZqhzZVH1X/upload.png'); ?>" style="" alt="Apex Innovations" /></a>
  </div>
